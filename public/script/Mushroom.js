class Mushroom
{
    ...
    {   
        ...
        {
            if (hero.collideLeft <= this.sprite.x + visibilityZoneWidth &&
            ...
            else if (hero.collideRight >= this.sprite.x - visibilityZoneWidth &&
        ...
        this.createSmoke = function (direction)
        {
        ...
        this.updateAggression = function ()
        {
            if (!hero.dead)
            {
                if (hero.collideLeft <= this.sprite.x + attackZoneWidth &&
                    hero.collideLeft + hero.sprite.width / 2 > this.sprite.x &&
                    hero.collideBottom >= this.sprite.y && 
                    hero.collideTop <= this.sprite.y)
                {
                ...
                else if (hero.collideRight >= this.sprite.x - attackZoneWidth &&
                    hero.collideRight - hero.sprite.width / 2 < this.sprite.x &&
                    hero.collideBottom >= this.sprite.y - this.sprite.height / 2 &&
                    hero.collideTop <= this.sprite.y + this.sprite.height / 2)
                {
